<script> 
  ...
  var table_warehouse_name = $('table.table-table_warehouse_location_name');
  var _table_api = initDataTable(table_warehouse_name, admin_url+'warehouse/table_warehouse_location_name', [0], [0], '',  [1, 'asc']);


var warehouse_type_value = {};
    function new_warehouse_type(){ alert("AAA");
      "use strict";
