...
function checkin(client){
		if (navigator.geolocation) {
			...
			//alert(parseFloat(pos.coords.latitude).toFixed(2)+"=="+parseFloat($('#cust_lat').html()).toFixed(2));
			if(parseFloat(pos.coords.latitude).toFixed(2)==parseFloat($('#cust_lat').html()).toFixed(2) && parseFloat(pos.coords.longitude).toFixed(2)==parseFloat($('#cust_lon').html()).toFixed(2)){
				console.log("123");
				$.ajax({
					type: "POST",
					url: admin_url + "warehouse/save_checkin",//this  should be replace by your server side method
					data: {
	...
	function checkout(client,se_log_id){
		if (navigator.geolocation) {
			...
			if(parseFloat(pos.coords.latitude).toFixed(2)==parseFloat($('#cust_lat').html()).toFixed(2) && parseFloat(pos.coords.longitude).toFixed(2)==parseFloat($('#cust_lon').html()).toFixed(2)){
				...
				$.ajax({
					type: "POST",
					url: admin_url + "warehouse/save_checkout",//this  should be replace by your server side method
					data: {
						lat: pos.coords.latitude,
						lon: pos.coords.longitude,
						dc_id: client,
