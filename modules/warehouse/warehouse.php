...
function warehouse_module_init_menu_items()
{
    ...
    if (has_permission('warehouse', '', 'view')) {
        ...
        /* Add for Storage Location Menu Start */
        $CI->app_menu->add_sidebar_children_item('warehouse', [
            'slug' => 'wa_manage_warehouse_location',
            'name' => _l('warehouse Location'),
            'icon' => 'fa fa-map-marker menu-icon',
            'href' => admin_url('warehouse/warehouse_location_manage'),
            'position' => 8,
        ]);
        /* Add for Storage Location Menu End */
...
{
    echo form_hidden('proposals_processing', $proposals_processing);
}
