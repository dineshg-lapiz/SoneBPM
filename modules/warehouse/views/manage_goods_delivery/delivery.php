                  ...
                  <?php } ?>
                    ...
                    <div class="col-md-3 form-group" >
                      <?php $invoice_no = (isset($goods_delivery) ? $goods_delivery->invoice_no : '');
					   if(isset($related_to) && $related_to=="saleorder"){ 
					   	$invoice_no = format_salesorder_number($invoice['id']);
						}
                        ...
                        <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                          <thead>
                            <tr>
                              ...
                              <th width="15%" align="left"><?php echo _l('Storage Location'); ?></th>
