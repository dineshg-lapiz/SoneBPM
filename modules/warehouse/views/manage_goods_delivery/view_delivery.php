...
<div class="col-md-12 no-padding">
   <div class="panel_s">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                 ...
                 <?php } ?>
                  ...
                  <li role="presentation" >	
                     <a href="#tab_deliverylog" class="tab_activilog" aria-controls="tab_deliverylog" role="tab" data-toggle="tab">	
                     <?php echo _l('Delivery Log'); ?>	
                     </a>	
                  </li>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                     <div class="pull-right _buttons">
                         <?php $checked_in = $this->warehouse_model->verify_checked_id($goods_delivery->id); ?>	
					 	<?php if(isset($checked_in->checked_in) && $checked_in->checked_in=="1"){ //print "<pre>";print_r($checked_in); ?>	
						<a href="#" class="check_out" data-toggle="tooltip" title="CheckOut" onclick="checkout('<?php echo $goods_delivery->id; ?>','<?php echo $checked_in->id; ?>');" data-placement="bottom" >	
							Check OUT	
						</a>	
						<?php }else{ ?>	
						<a href="#" class="check_in" data-toggle="tooltip" title="CheckIn" onclick="checkin('<?php echo $goods_delivery->id; ?>');" data-placement="bottom" >	
							Check IN	
						</a>	
						<?php } ?>
                ...
                if($goods_delivery){
                    ...
                    if(is_numeric($goods_delivery->customer_code)){
                      ...
                      if($customer_value){
                        ...
                        $cust_lat = $customer_value->latitude;	
						$cust_lon = $customer_value->longitude;
                      }
                  }
                 ...
                 ?>
                  ...
                  <tr class="project-overview">
                    ...
                    <div style="display:none;" id="cust_lat"><?php echo $cust_lat; ?></div>	
					<div style="display:none;" id="cust_lon"><?php echo $cust_lon; ?></div>
                 </tr>
                 <tr class="project-overview">
                 ...
                 <?php 
                      if( ($goods_delivery->invoice_id != '') && ($goods_delivery->invoice_id != 0) ){ ?>
                        ...
                        <tr class="project-overview">
                          ...
                          <td>
						  <?php if(str_contains($goods_delivery->invoice_no,'SO')){ ?>
						  	  <a href="<?php echo admin_url('invoices#'.$goods_delivery->invoice_id) ?>" ><?php echo format_salesorder_number($goods_delivery->invoice_id).get_invoice_company_projecy($goods_delivery->invoice_id) ?></a>
						  <?php }else{ ?>
    ...
    <?php } ?>
        ...
        <div role="tabpanel" class="tab-pane" id="tab_deliverylog">	
    		<table class="table dt-table">	
    			...
    			<tbody>	
    				<?php //print "<pre>";print_r($se_logs);	
    				$se_logs = $this->warehouse_model->se_logs($goods_delivery->id);	
    				 foreach ($se_logs as $se_log) { ?>	
    				<tr>	
    					<td><?php $staf = get_staff($se_log["se_id"]); echo $staf->username; ?></td>	
    					<td><?php echo $staf->firstname." ".$staf->lastname; ?></td>	
    					<td><?php echo $se_log["visit_date"]; ?></td>	
    					<td><?php echo date('H:i:s', strtotime($se_log["check_in_time"])); ?></td>	
    					<td><?php echo date('H:i:s', strtotime($se_log["check_out_time"])); ?></td>	
    					<td><?php echo date('H:i', mktime(0, $se_log["duration"])); //intdiv($se_log["duration"], 60).' : '. ($se_log["duration"] % 60); ?></td>	
    				</tr>	
    				<?php } ?>	
    			</tbody>	
    		</table>	
