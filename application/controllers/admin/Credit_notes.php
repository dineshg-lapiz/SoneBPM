...
class Credit_notes extends AdminController
{
    ...
    public function credit_note($id = '')
    {
        ...
        if ($id == '') {
			...
			//print "<pre>";print_r($credit_note);exit;
			
			/*foreach($credit_note->items as $item){
				$available_qty = $this->credit_notes_model->get_item_available_qty_by_name($item["description"]);
			...
			$credit_note->items = $invoice_items;*/
