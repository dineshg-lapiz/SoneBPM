...
*
*/
define('APP_BASE_URL', 'https://demo.sonebpm.com/');
...
*/
define('APP_ENC_KEY', '3f32cd7c3987a2eabd24978bec1dad3b');
 ...
 */
define('APP_DB_USERNAME', 'zercoaru_soneadmin');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Soneadmin@2023');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'zercoaru_sonebpm');
