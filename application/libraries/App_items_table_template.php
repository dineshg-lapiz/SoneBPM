...
abstract class App_items_table_template
{
    ...
    public function __construct()
    {
		...
		$this->proposal_tax_per_item   = get_option('proposal_show_tax_per_item') == 1;
    ...
    */
    ...
    protected function show_tax_per_item()
    {
		...
		if($get_type[2]=="proposals" && $this->proposal_tax_per_item==0){
			return $this->tax_per_item && hooks()->apply_filters('show_tax_per_item', false, [
				'type'        => $this->type,
				'transaction' => $this->transaction,
			]);
		}else{
