...
class Estimate_merge_fields extends App_merge_fields
{
    ...
    public function format($estimate_id)
    {
		...
		$fields['{estimate_id}']   = $estimate_id;
		...
		$fields['{bill_to}']  = format_customer_info($estimate, 'estimate', 'billing');
		$fields['{ship_to}']  = format_customer_info($estimate, 'estimate', 'shipping');
