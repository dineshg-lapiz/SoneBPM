...
abstract class App_pdf extends TCPDF
{
    ...
    public function __construct()
    {
        ...
        /*$img_file = 'http://indusautomation.co.in/assets/images/bg_image.jpg';
    ...
    {
		if ($this->page == 1) {
            /*$image_file = 'http://indusautomation.co.in/assets/images/nano-header.png';
            $this->Image($image_file, 3, 10, '', '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);*/
        }
    ...
    public function Footer()
    {
		...
		/*$image_file = 'http://indusautomation.co.in/assets/images/nano-footer.png';
        $this->Image($image_file, 3, $this->GetY()-12, '', '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);*/
    }
