                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     ?>
                        ...
                        <li <?php if ($disable_convert) {
                         echo 'data-toggle="tooltip" title="' . _l($help_text, _l('proposal_convert_saleorder')) . '"';
                     } ?>><a href="#" <?php if ($disable_convert) {
                         echo 'style="cursor:not-allowed;" onclick="return false;"';
                     } else {
                         echo 'data-template="salesorder" onclick="proposal_convert_template(this); return false;"';
                     } ?>><?php echo _l('proposal_convert_saleorder'); ?></a></li>
                        <?php //} ?>
                    </ul>
                </div>
                <?php } ?>
