         ...
         ?>
            ...
            <div class="col-md-12">
             ...
             echo '<option value="' . $rel_val['id'] . '" selected>' . $rel_val['name'] . '</option>';
                           ...
                           ?>
                              ...
                              ?>
								...
								<div class="row mtop10">
                                        <div class="col-md-6 select-placeholder">
                                            ...
                                            <select name="template_id" class="selectpicker" data-width="100%"
												...
												<?php foreach($templates as $template) { ?>
													<option value="<?php echo $template["id"]; ?>" <?php if (isset($estimate) && $estimate->template_id == $template["id"]) { echo 'selected'; } ?>><?php echo $template["name"]; ?></option>
												<?php } ?>
                                            </select>
                                        </div>
                                    </div>
					...
					<div class="panel-body">
						<?php $value = (isset($proposal) ? $proposal->clientnote : get_option('predefined_clientnote_proposal')); ?>
						<?php echo render_textarea('clientnote', 'proposal_add_edit_client_note', $value); ?>
						<?php $value = (isset($proposal) ? $proposal->terms : get_option('predefined_terms_proposal')); ?>
