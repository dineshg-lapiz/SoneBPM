...
<div class="modal fade proposal-convert-modal" id="convert_to_salesorder" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-xxl" role="document">
        <?php echo form_open('admin/proposals/convert_to_salesorder/' . $proposal->id, ['id' => 'proposal_convert_to_salesorder_form', 'class' => '_transaction_form invoice-form']); ?>
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo _l('proposal_convert_to_salesorder'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php $this->load->view('admin/salesorder/proposal_to_salesorder_template'); ?>
                    </div>
                </div>
            </div>
...
<script>
    ...
    init_color_pickers();
    init_items_sortable();
    validate_salesorder_form('#proposal_convert_to_salesorder_form');
    ...
    <?php } else { ?>
        $('#convert_to_salesorder select#currency').val("<?php echo $proposal->currency ?>").trigger('change');
