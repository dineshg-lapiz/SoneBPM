...
<div class="tab-content mtop15">
    ...
    ?>
	<hr />
        <?php echo render_textarea('settings[predefined_clientnote_proposal]', 'settings_predefined_clientnote', get_option('predefined_clientnote_proposal'), ['rows' => 6]); ?>
        <?php echo render_textarea('settings[predefined_terms_proposal]', 'settings_predefined_predefined_term', get_option('predefined_terms_proposal'), ['rows' => 6]); ?>
    </div>
