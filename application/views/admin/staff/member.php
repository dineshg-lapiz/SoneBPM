...
<div id="wrapper">
                        ...
                        <div class="horizontal-scrollable-tabs panel-full-width-tabs">
                            ...
                            <div class="horizontal-tabs">
                                <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                                    ...
                                    <li role="presentation">
                                        <a href="#group_members" aria-controls="group_members" role="tab"
                                            data-toggle="tab">
                                            <?php echo _l('Add Members'); ?>
                                        </a>
                                    </li>
                                </ul>
                            </div>
    ...
    echo ' hide';
                     ...
                     ?>
                            ...
                            <div role="tabpanel" class="tab-pane" id="group_members">
								<div class="col-md-12">
                                        <?php
									 $selected = [];
									 if (isset($staff_members)) { //print "<pre>";print_r($staff_members);
										 foreach ($staff_members as $member) {
											 array_push($selected, $member['staffid']);
										 }
									 }
									echo render_select('staff_members[]', $staff, ['staffid', ['firstname', 'lastname']], 'staff_members', $selected, ['multiple' => true, 'data-actions-box' => true], [], '', '', false);
									?>
								</div>
							</div>
