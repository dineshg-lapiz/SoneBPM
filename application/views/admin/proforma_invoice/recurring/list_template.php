    ...
    <div class="tw-mb-2 sm:tw-mb-4">
        ...
        <div class="_buttons">
            ...
            <a href="<?php echo admin_url('Proforma_Invoice/invoice'); ?>"
                ...
                <?php echo _l('create new Proforma Invoice'); ?>

            </a>

            <?php } ?>

            <a href="<?php echo admin_url('Proforma_Invoice'); ?>" class="btn btn-default pull-left mleft5">
        ...
        <div class="col-md-12" id="small-table">
            ...
            <div class="panel_s panel-table-full">
                ...
                <div class="panel-body">
                    ...
                    <?php $this->load->view('admin/Proforma_Invoice/recurring/table_html'); ?>
