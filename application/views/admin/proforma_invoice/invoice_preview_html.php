      ...
      if ($invoice->recurring > 0 || $invoice->is_recurring_from != null) {
        ...
        <div class="col-md-12">
         ...
         && $recurring_invoice->cycles == $recurring_invoice->total_cycles) { ?>
            ...
            <?php echo '<p class="text-muted' . ($show_recurring_invoice_info ? ' mtop15': '') . '">' . _l('invoice_recurring_from', '<a href="' . admin_url('invoices/list_invoices/' . $invoice->is_recurring_from) . '" onclick="init_invoice(' . $invoice->is_recurring_from . ');return false;">' . format_proforma_number($invoice->is_recurring_from) . '</a></p>'); ?>
        ...
        ?>
                ...
                <a href="<?php echo admin_url('invoices/invoice/' . $invoice->id); ?>">
                    ...
                    <span id="invoice-number">
                        ...
                        <?php echo format_proforma_number($invoice->id); ?>
