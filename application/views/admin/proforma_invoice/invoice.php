            ...
            <div class="col-md-12">
                ...
                <h4
                    ...
                    <span>
                        ...
                        <?php echo isset($invoice) ? format_proforma_number($invoice) : _l('Create New Proforma Invoice'); ?>
                ...
                <?php $this->load->view('admin/proforma_invoice/invoice_template'); ?>

            </div>

            <?php echo form_close(); ?>

            <?php $this->load->view('admin/proforma_invoice_items/item'); ?>
