        ...
        <div class="row">
            ...
            <div id="merge" class="col-md-6">
              ...
              if (isset($invoice)) {
                  ...
                  $this->load->view('admin/Proforma_Invoice/merge_invoice', ['invoices_to_merge' => $invoices_to_merge]);
            ...
            <div id="expenses_to_bill" class="col-md-6">
                ...
                $this->load->view('admin/Proforma_Invoice/bill_expenses', ['expenses_to_bill' => $expenses_to_bill]);
...
<label for="clientid" class="control-label"><?php echo _l('invoice_select_customer'); ?></label>
            ...
            if (!isset($invoice_from_project)) { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php include_once(APPPATH . 'views/admin/Proforma_Invoice/billing_and_shipping_template.php'); ?>
               ...
               $prefix = get_option('Proforma_invoice_prefix');
    ...
    <div class="panel-body">
        ...
        <div class="row">
			...
			<?php if(isset($convert) && $convert=="so_to_invoice"){ ?>
