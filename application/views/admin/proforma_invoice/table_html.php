...
$custom_fields = get_custom_fields('invoice',array('show_on_table'=>1)); //invoicesproforma
...
$table_data = hooks()->apply_filters('invoices_table_columns', $table_data);//invoicesproforma

render_datatable($table_data, (isset($class) ? $class : 'proforma')); //invoicesproforma
