...
<div class="col-md-12">
    ...
    <div class="tw-mb-2 sm:tw-mb-4">
        ...
        <div class="_buttons">
            ...
            <?php $this->load->view('admin/proforma_invoice/invoices_top_stats'); ?>

            <?php if (has_permission('Proforma_invoices', '', 'create')) { ?>

            <a href="<?php echo admin_url('Proforma_Invoice/invoice'); ?>"

                class="btn btn-primary pull-left new new-invoice-list mright5">

                <i class="fa-regular fa-plus tw-mr-1"></i>

                <?php echo _l('Create Proforma Invoice'); ?>
            ...
            <a href="<?php echo admin_url('Proforma_Invoice/recurring'); ?>" class="btn btn-default pull-left mleft5">
        ...
        <div class="col-md-12" id="small-table">
            ...
            <div class="panel_s">
                ...
                <div class="panel-body panel-table-full">
                    ...
                    <?php $this->load->view('admin/proforma_invoice/table_html'); ?>
