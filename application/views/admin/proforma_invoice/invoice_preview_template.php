    ...
    <div class="panel-body">
        ...
        <div class="tw-flex tw-justify-between tw-items-center tw-mb-2 last:tw-mb-0">
            ...
            <div>
                ...
                <a href="<?php echo admin_url('Proforma_Invoice/list_invoices/' . $_inv->id); ?>" target="_blank"

                    class="tw-font-medium"><?php echo format_proforma_number($_inv->id); ?></a> -
    ...
    [
                ...
                <div class="col-md-9 _buttons">
                    ...
                    <div class="pull-right">
                     ...
                     ?>
                        ...
                        <a href="<?php echo admin_url('Proforma_Invoice/invoice/' . $invoice->id); ?>" data-toggle="tooltip"
                         ...
                         echo ' PDF';
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="hidden-xs"><a
                                        ...
                                        href="<?php echo admin_url('Proforma_Invoice/pdf/' . $invoice->id . '?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a>

                                </li>

                                <li class="hidden-xs"><a

                                        href="<?php echo admin_url('Proforma_Invoice/pdf/' . $invoice->id . '?output_type=I'); ?>"

                                        target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>

                                <li><a

                                        href="<?php echo admin_url('Proforma_Invoice/pdf/' . $invoice->id); ?>"><?php echo _l('download'); ?></a>

                                </li>

                                <li>

                                    <a href="<?php echo admin_url('Proforma_Invoice/pdf/' . $invoice->id . '?print=true'); ?>"
                         ...
                         echo ' disabled';
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="<?php echo site_url('Proforma_Invoice/' . $invoice->id . '/' . $invoice->hash) ?>"
                                    ...
                                    <li>
                                        ...
                                        <a
                                            ...
                                            href="<?php echo admin_url('Proforma_Invoice/send_overdue_notice/' . $invoice->id); ?>">
                           ...
                           && !empty($invoice->clientid)) {?>
                                    ...
                                    <?php if (has_permission('Proforma_Invoice', '', 'create')) { ?>

                                    <li>

                                        <a

                                            href="<?php echo admin_url('Proforma_Invoice/copy/' . $invoice->id); ?>"><?php echo _l('invoice_copy'); ?></a>
                                    ...
                                    <li>
                                        ...
                                        <a
                                            ...
                                            href="<?php echo admin_url('Proforma_Invoice/mark_as_sent/' . $invoice->id); ?>"><?php echo _l('invoice_mark_as_sent'); ?></a>
                              ...
                              && $invoice->status != Invoices_model::STATUS_PARTIALLY) { ?>
                                        ...
                                        <a
                                            ...
                                            href="<?php echo admin_url('Proforma_Invoice/mark_as_cancelled/' . $invoice->id); ?>"><?php echo _l('invoice_mark_as', _l('invoice_status_cancelled')); ?></a>

                                        <?php } elseif ($invoice->status == Invoices_model::STATUS_CANCELLED) { ?>

                                        <a

                                            href="<?php echo admin_url('Proforma_Invoice/unmark_as_cancelled/' . $invoice->id); ?>"><?php echo _l('invoice_unmark_as', _l('invoice_status_cancelled')); ?></a>
                           ...
                           && is_invoices_overdue_reminders_enabled()) { ?>
                                    ...
                                    <li>
                                        ...
                                        <a
                                            ...
                                            href="<?php echo admin_url('Proforma_Invoice/resume_overdue_reminders/' . $invoice->id); ?>"><?php echo _l('resume_overdue_reminders'); ?></a>

                                        <?php } else { ?>

                                        <a

                                            href="<?php echo admin_url('Proforma_Invoice/pause_overdue_reminders/' . $invoice->id); ?>"><?php echo _l('pause_overdue_reminders'); ?></a>
                           ...
                           if ((get_option('delete_only_on_last_invoice') == 1 && is_last_invoice($invoice->id)) || (get_option('delete_only_on_last_invoice') == 0)) { ?>
                                    ...
                                    <li data-toggle="tooltip" data-title="<?php echo _l('delete_invoice_tooltip'); ?>">
                                        ...
                                        <a href="<?php echo admin_url('Proforma_Invoice/delete/' . $invoice->id); ?>"
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="tab_invoice">
                    ...
                    <?php $this->load->view('admin/Proforma_Invoice/invoice_preview_html'); ?>
                ...
                <div class="tab-pane" role="tabpanel" id="invoice_payments_received">
                    ...
                    <?php include_once(APPPATH . 'views/admin/Proforma_Invoice/invoice_payments_table.php'); ?>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_child_invoices">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <a href="<?php echo admin_url('Proforma_Invoice/list_invoices/' . $recurring->id); ?>"

                                class="tw-font-semibold"

                                onclick="init_invoice(<?php echo $recurring->id; ?>); return false;"

                                target="_blank"><?php echo format_proforma_number($recurring->id); ?>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_notes">
                    ...
                    <?php echo form_open(admin_url('Proforma_Invoice/add_note/' . $invoice->id), ['id' => 'sales-notes', 'class' => 'invoice-notes-form']); ?>
...
<?php $this->load->view('admin/Proforma_Invoice/invoice_send_to_client'); ?>
