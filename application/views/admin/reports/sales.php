            ...
            <div class="sm:tw-border-r sm:tw-border-solid sm:tw-border-neutral-200 tw-pr-10 tw-w-96">
                ...
                <ul class="reports tw-space-y-1">
                    ...
                    <li>	
                        <a href="#"	
                            class="group tw-font-medium tw-px-3 tw-py-3 tw-text-neutral-500 hover:tw-text-neutral-800 active:tw-text-neutral-800 focus:tw-text-neutral-800 hover:tw-bg-neutral-200 tw-w-full tw-inline-flex tw-items-center tw-rounded-md data-[active=true]:tw-bg-neutral-200 data-[active=true]:tw-text-neutral-800"	
                            onclick="init_report(this, 'salesorder-report'); return false;">	
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"	
                                stroke="currentColor"	
                                class="tw-w-5 tw-h-5 tw-mr-2.5 tw-text-neutral-500 group-hover:tw-text-neutral-800">	
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />	
                            </svg>	
                            <?php echo _l('Salesorder Report'); ?>	
                        </a>	
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>	
                        <a href="#"	
                            class="group tw-font-medium tw-px-3 tw-py-3 tw-text-neutral-500 hover:tw-text-neutral-800 active:tw-text-neutral-800 focus:tw-text-neutral-800 hover:tw-bg-neutral-200 tw-w-full tw-inline-flex tw-items-center tw-rounded-md data-[active=true]:tw-bg-neutral-200 data-[active=true]:tw-text-neutral-800"	
                            onclick="init_report(this, 'log-report'); return false;">	
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"	
                                stroke="currentColor"	
                                class="tw-w-5 tw-h-5 tw-mr-2.5 tw-text-neutral-500 group-hover:tw-text-neutral-800">	
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />	
                            </svg>	
                            <?php echo _l('Visit Log Report'); ?>	
                        </a>	
                    </li>	
					<li>	
                        <a href="#"	
                            class="group tw-font-medium tw-px-3 tw-py-3 tw-text-neutral-500 hover:tw-text-neutral-800 active:tw-text-neutral-800 focus:tw-text-neutral-800 hover:tw-bg-neutral-200 tw-w-full tw-inline-flex tw-items-center tw-rounded-md data-[active=true]:tw-bg-neutral-200 data-[active=true]:tw-text-neutral-800"	
                            onclick="init_report(this, 'dc-log-report'); return false;">	
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"	
                                stroke="currentColor"	
                                class="tw-w-5 tw-h-5 tw-mr-2.5 tw-text-neutral-500 group-hover:tw-text-neutral-800">	
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />	
                            </svg>	
                            <?php echo _l('DC Visit Log Report'); ?>	
                        </a>	
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-12 hide" id="report">
                ...
                <div class="panel_s">
                    <div class="panel-body panel-table-full">
                        ...
                        <?php $this->load->view('admin/reports/includes/sales_salesorder'); ?>	
						<?php $this->load->view('admin/reports/includes/sales_visitlogs'); ?>	
						<?php $this->load->view('admin/reports/includes/sales_dc_visitlogs'); ?>
                    </div>
                </div>
            </div>
        </div>
