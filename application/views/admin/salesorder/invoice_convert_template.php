...
<div class="modal fade proposal-convert-modal" id="convert_to_invoice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-xxl" role="document">
        <?php echo form_open('admin/salesorder/convert_to_invoice/' . $proposal->id, ['id' => 'salesorder_convert_to_invoice_form', 'class' => '_transaction_form invoice-form']); ?>
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo _l('salesorder_convert_to_invoice'); ?></span>
                </h4>
            </div>
