...
$table_data = array(
  _l('salesorder_dt_table_heading_number'),
...
$table_data = hooks()->apply_filters('salesorder_table_columns', $table_data);
render_datatable($table_data, (isset($class) ? $class : 'salesorder'));
?>
