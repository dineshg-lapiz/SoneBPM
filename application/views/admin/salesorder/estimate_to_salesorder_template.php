...
<div class="panel_s invoice accounting-template">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="f_client_id">
                    <div class="form-group select-placeholder">
                        <label for="clientid" class="control-label"><?php echo _l('invoice_select_customer'); //print "<pre>";print_r($estimate); ?></label>
            ...
            if (!isset($invoice_from_project)) { ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php include_once(APPPATH . 'views/admin/salesorder/billing_and_shipping_template.php'); ?>
                    </div>
                    <div class="col-md-6">
                ...
                <?php
               $next_invoice_number = get_option('next_salesorder_number');
               ...
               $prefix = get_option('salesorder_prefix');
               ...
               ?>
                <div class="form-group">
                    <label for="number">
                        <?php echo _l('salesorder_add_edit_number'); ?>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                            ...
                            <a href="#" onclick="return false;" data-toggle="popover"
                                ...
                                data-content="<label class='control-label'><?php echo _l('settings_sales_salesorder_prefix'); ?></label><div class='input-group'><input name='s_prefix' type='text' class='form-control' value='<?php echo $estimate->prefix; ?>'></div><button type='button' onclick='save_sales_number_settings(this); return false;' data-url='<?php echo admin_url('salesorder/update_number_settings/' . $estimate->id); ?>' class='btn btn-primary btn-block mtop15'><?php echo _l('submit'); ?></button>">
                                <i class="fa fa-cog"></i>
                            </a>
                            <?php }
                    echo $prefix;
                  ...
                  ?>
                        ...
                        <input type="text" name="number" class="form-control"
                            value="<?php echo ($_is_draft) ? 'DRAFT' : $_estimate_number; ?>"
                ...
                <div class="row">
                  ...
                  $date_attrs        = [];
                  if (isset($estimate) && isset($estimate->recurring) && $estimate->recurring > 0 && $estimate->last_recurring_date != null) {
                      $date_attrs['disabled'] = true;
                  }
                  ?>
                        <?php echo render_date_input('date', 'salesorder_add_edit_date', $value, $date_attrs); ?>
                    </div>
                    <div class="col-md-6">
                        <?php
                  $value = '';
                  if (isset($estimate)) {
                   ...
                   ?>
                        <?php echo render_date_input('duedate', 'salesorder_add_edit_duedate', $value); ?>
                    </div>
                </div>
                <?php if (is_invoices_overdue_reminders_enabled()) { ?>
                <!--<div class="form-group">
                    <div class="checkbox checkbox-danger">
                        <input type="checkbox" <?php if (isset($estimate) && $estimate->cancel_overdue_reminders == 1) {
                       echo 'checked';
            ...
            <div class="col-md-6">
                <div class="tw-ml-3">
                   ...
                   $selected = '';
                   if (isset($estimate)) {
                       if ($estimate->allowed_payment_modes) {
                           $inv_modes = unserialize($estimate->allowed_payment_modes);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group select-placeholder"
                                <?php if (isset($estimate) && !empty($estimate->is_recurring_from)) { ?>
                                data-toggle="tooltip"
                                ...
                                <label for="recurring" class="control-label">
                                    <?php echo _l('salesorder_add_edit_recurring'); ?>
                                </label>
                        ...
                        if (isset($estimate) && !empty($estimate->is_recurring_from)) {
                            echo 'disabled';
                        } ?>>
                                    <?php for ($i = 0; $i <= 12; $i++) { ?>
                                    <?php
                              $selected = '';
                              if (isset($estimate)) {
                                  if ($estimate->custom_recurring == 0) {
                                      if ($estimate->recurring == $i) {
                                          $selected = 'selected';
                                      }
                                  }
                              }
                              ...
                              ?>
                                    ...
                                    <?php } ?>
                                    <option value="custom" <?php if (isset($estimate) && isset($estimate->recurring) && $estimate->recurring != 0 && $estimate->custom_recurring == 1) {
                                  echo 'selected';
                        ...
                        <div class="recurring_custom <?php //if ((isset($estimate) && isset($estimate->custom_recurring) && $estimate->custom_recurring != 1) ) {
                                  echo 'hide';
                             // } ?>">
                            <div class="col-md-6">
                                <?php $value = (isset($estimate) && isset($estimate->custom_recurring) && $estimate->custom_recurring == 1 ? $estimate->recurring : 1); ?>
                            ...
                            <div class="col-md-6">
                                <select name="repeat_type_custom" id="repeat_type_custom" class="selectpicker"
                                    data-width="100%"
                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <option value="day" <?php if (isset($estimate) && isset($estimate->custom_recurring) && $estimate->custom_recurring == 1 && $estimate->recurring_type == 'day') {
                                  echo 'selected';
                              } ?>><?php echo _l('invoice_recurring_days'); ?></option>
                                    <option value="week" <?php if (isset($estimate) && isset($estimate->custom_recurring) && $estimate->custom_recurring == 1 && $estimate->recurring_type == 'week') {
                                  echo 'selected';
                              } ?>><?php echo _l('invoice_recurring_weeks'); ?></option>
                                    <option value="month" <?php if (isset($estimate) && isset($estimate->custom_recurring) && $estimate->custom_recurring == 1 && $estimate->recurring_type == 'month') {
                                  echo 'selected';
                              } ?>><?php echo _l('invoice_recurring_months'); ?></option>
                                    <option value="year" <?php if (isset($estimate) && isset($estimate->custom_recurring) && $estimate->custom_recurring == 1 && $estimate->recurring_type == 'year') {
                                  echo 'selected';
                              } ?>><?php echo _l('invoice_recurring_years'); ?></option>
                                </select>
                            </div>
                        </div>
                        <div id="cycles_wrapper" class="<?php //if (!isset($estimate) || (isset($estimate) && isset($estimate->custom_recurring) && $estimate->recurring == 0)) {
                                  echo ' hide';
                              //}?>">
                            <div class="col-md-12">
                                <?php $value = 0; ?>
                                <div class="form-group recurring-cycles">
                                    <label for="cycles"><?php echo _l('recurring_total_cycles'); ?>
                                        <?php if (isset($estimate) && isset($estimate->total_cycles) && $estimate->total_cycles > 0) {
                                  echo '<small>' . _l('cycles_passed', $estimate->total_cycles) . '</small>';
                              }
                            ?>
                                    </label>
                                    <div class="input-group">
                                ...
                                echo ' disabled';
                            } ?> name="cycles" id="cycles" value="<?php echo $value; ?>" <?php if (isset($estimate) && isset($estimate->total_cycles) && $estimate->total_cycles > 0) {
                                echo 'min="' . ($estimate->total_cycles) . '"';
                            } ?>>
                ...
                <div class="form-group select-placeholder input-group-select form-group-select-task_select popover-250">
                    <div class="input-group input-group-select">
                        ...
                        <div class="input-group-addon input-group-addon-bill-tasks-help">
                            <?php
                    if (isset($estimate) && !empty($estimate->project_id)) {
                        $help_text = _l('showing_billable_tasks_from_project') . ' ' . get_project_name_by_id($estimate->project_id);
                    } else {
                ...
                <div class="mtop10">
                    ...
                    <div class="radio radio-primary radio-inline">
                        <input type="radio" value="1" id="sq_1" name="show_quantity_as"
                            data-text="<?php echo _l('invoice_table_quantity_heading'); ?>" <?php if (isset($estimate) && $estimate->show_quantity_as == 1) {
                                echo 'checked';
                    ...
                    <div class="radio radio-primary radio-inline">
                        <input type="radio" value="2" id="sq_2" name="show_quantity_as"
                            data-text="<?php echo _l('invoice_table_hours_heading'); ?>" <?php if (isset($estimate) && $estimate->show_quantity_as == 2 || isset($hours_quantity)) {
                                echo 'checked';
                            } ?>>
                    ...
                    <div class="radio radio-primary radio-inline">
                        <input type="radio" value="3" id="sq_3" name="show_quantity_as"
                            data-text="<?php echo _l('invoice_table_quantity_heading'); ?>/<?php echo _l('invoice_table_hours_heading'); ?>" <?php if (isset($estimate) && $estimate->show_quantity_as == 3 || isset($qty_hrs_quantity)) {
                                echo 'checked';
                            } ?>>
                        <label
            ...
            <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                <thead>
                    <tr>
						...
						<!--<th width="10%" align="left"><?php echo _l('available_qty'); ?></th>-->
                        <?php
                ...
                <tbody>
                    <tr class="main">
						...
						<!--<td>
                            <input type="number" name="available_quantity" id="available_quantity" min="0" value="1" readonly class="form-control"
                    ...
                    <?php if (isset($estimate) || isset($add_items)) {
                            ...
                            foreach ($add_items as $item) {
                                ...
                                $invoice_item_taxes = get_estimate_item_taxes($item['id']);
								//print $item['id'];print "<pre>";print_r($invoice_item_taxes);
                                // passed like string
                                if ($item['id'] == 0) {
								...
								//$table_row .= '<td><input type="number" min="0" readonly data-available_quantity name="' . $items_indicator . '[' . $i . '][available_quantity]" value="' . $item['available_quantity'] . '" class="form-control">';
                      ...
                      echo _l('discount_fixed_amount');
                                        ...
                                        ?>
                                            ...
                                            echo ' selected';
                                                    ...
                                                    <li><a href="#" class="discount-total-type discount-type-fixed<?php if (isset($estimate) && is_sale_discount($estimate, 'fixed')) {
                                            echo ' selected';
                                        } ?>">
    ...
    <div class="panel-body">
        <?php $value = (isset($estimate) ? $estimate->clientnote : get_option('predefined_clientnote_invoice')); ?>
        <?php echo render_textarea('clientnote', 'invoice_add_edit_client_note', $value); ?>
        <?php $value = (isset($estimate) ? $estimate->terms : get_option('predefined_terms_invoice')); ?>
        <?php echo render_textarea('terms', 'terms_and_conditions', $value, [], [], 'mtop15'); ?>
    </div>

    <?php hooks()->do_action('after_render_invoice_template', isset($estimate) ? $estimate : false); ?>
</div>
...
<div class="btn-bottom-toolbar text-right">
    ...
    <div class="btn-group dropup">
        <button type="button"
            class="btn-tr btn btn-primary invoice-form-submit transaction-submit" ><?php echo _l('confirm_salesorder'); ?></button><!--onclick="check_stocks();"-->
