...
<div class="col-md-12">
    <div class="tw-mb-2 sm:tw-mb-4">
        <div class="_buttons">
            <?php $this->load->view('admin/salesorder/invoices_top_stats');  ?>
            <?php if (has_permission('salesorder', '', 'create')) { ?>
            <a href="<?php echo admin_url('salesorder/invoice'); ?>"
            ...
            <!--<a href="<?php echo admin_url('invoices/recurring'); ?>" class="btn btn-default pull-left mleft5">
                ...
                <?php echo _l('salesorder_list_recurring'); ?>
            </a>-->
            <?php } ?>
                    ...
                    <ul class="dropdown-menu width300">
                        <li>
                            <a href="#" data-cview="all"
                                onclick="dt_custom_view('','.table-salesorder',''); return false;">
    ...
    echo 'active';
                            ...
                            <a href="#" data-cview="not_sent"
                                onclick="dt_custom_view('not_sent','.table-salesorder','not_sent'); return false;">
                                <?php echo _l('not_sent_indicator'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="#" data-cview="not_have_payment"
                                onclick="dt_custom_view('not_have_payment','.table-salesorder','not_have_payment'); return false;">
                                <?php echo _l('invoices_list_not_have_payment'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="#" data-cview="recurring"
                                onclick="dt_custom_view('recurring','.table-salesorder','recurring'); return false;">
    ...
    echo 'active';
                            ...
                            <a href="#" data-cview="salesorder_<?php echo $status; ?>"
                                onclick="dt_custom_view('salesorder_<?php echo $status; ?>','.table-salesorder','salesorder_<?php echo $status; ?>'); return false;"><?php echo $status; ?></a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="active">
                            <a href="#" data-cview="year_<?php echo $year['year']; ?>"
                                onclick="dt_custom_view(<?php echo $year['year']; ?>,'.table-salesorder','year_<?php echo $year['year']; ?>'); return false;"><?php echo $year['year']; ?>
                            </a>
                        </li>
                        <?php } ?>
                        <?php } ?>
                            ...
                            <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li>
                                    <a href="#" data-cview="sale_agent_<?php echo $agent['sale_agent']; ?>"
                                        onclick="dt_custom_view(<?php echo $agent['sale_agent']; ?>,'.table-salesorder','sale_agent_<?php echo $agent['sale_agent']; ?>'); return false;"><?php echo $agent['full_name']; ?>
                                    </a>
                                </li>
                                <?php } ?>
                            </ul>
        ...
        continue;
                        ...
                        <li>
                            <a href="#" data-cview="invoice_payments_by_<?php echo $mode['id']; ?>"
                                onclick="dt_custom_view('<?php echo $mode['id']; ?>','.table-salesorder','invoice_payments_by_<?php echo $mode['id']; ?>'); return false;">
                ...
                <a href="#" class="btn btn-default btn-with-tooltip toggle-small-view hidden-xs"
                    onclick="toggle_small_view('.table-salesorder','#salesorder'); return false;" data-toggle="tooltip"
                    title="<?php echo _l('invoices_toggle_table_tooltip'); ?>"><i
                        class="fa fa-angle-double-left"></i></a>
                <a href="#" class="btn btn-default btn-with-tooltip salesorder-total"
                    onclick="slideToggle('#stats-top'); init_salesorder_total(true); return false;" data-toggle="tooltip"
        ...
        <div class="col-md-12" id="small-table">
            <div class="panel_s">
                <div class="panel-body panel-table-full">
                    ...
                    <?php $this->load->view('admin/salesorder/table_html'); ?>
                </div>
            </div>
        </div>
        <div class="col-md-7 small-table-right-col">
            <div id="salesorder" class="hide">
            </div>
        </div>
    </div>
</div>