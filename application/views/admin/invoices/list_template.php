...
<div class="col-md-12">
    <div class="tw-mb-2 sm:tw-mb-4">
        <div class="_buttons">
            ...
            <?php } ?>
            <a href="javascript:void(0)" class="btn btn-default pull-left mleft5 print_pdf">

                <i class="fa-solid fa-file-pdf tw-mr-1"></i>

                <?php echo _l('Invoices Print'); ?>

            </a><form name="pdfall" action="<?php echo admin_url('invoices/printpdf_all/'); ?>" id="pdfall" method="POST">
            <input type="hidden" name="pdfs" id="prid" value="" />
