        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_filters _hidden_inputs hidden">
				  ...
				  foreach ($salesorder_statuses as $status) {
                      echo form_hidden('salesorder_' . $status);
                  }
                ...
                <div class="_buttons">
                    ...
                    <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip"
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                            ...
                            <div class="clearfix"></div>
                            <li class="divider"></li>
							<li class="dropdown-submenu pull-left salesorder">
                                <a href="#" tabindex="-1"><?php echo _l('salesorder'); ?></a>
                                <ul class="dropdown-menu dropdown-menu-left">
