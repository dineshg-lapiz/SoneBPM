...
$(function() {
	...
	/* Customer profile salesorder table */
    initDataTable('.table-salesorder-single-client',
        admin_url + 'salesorder/table/' + customer_id,
        'undefined',
        'undefined',
        'undefined', [
            [3, 'desc'],
...
function fetch_lat_long_from_google_cprofile_for_profile() {	
    var data = {};	
    data.address = $('#company').val()+' '+$('#address').val();	
    data.city = $('#city').val();	
