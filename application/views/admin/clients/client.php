                ...
                <h4 class="tw-text-lg tw-font-semibold tw-text-neutral-800 tw-mt-0">
                    <div class="tw-space-x-3 tw-flex tw-items-center">
                        ...
                        <div align="right">	
							...
							<a href="#" class="check_out" data-toggle="tooltip" title="CheckOut" onclick="checkout('<?php echo $client->userid; ?>','<?php echo $checked_in->id; ?>');" data-placement="bottom" >	
								Check OUT	
							</a>	
							<?php }else{ ?>	
							<a href="#" class="check_in" data-toggle="tooltip" title="CheckIn" onclick="checkin('<?php echo $client->userid; ?>');" data-placement="bottom" >Check IN</a>	
							<?php } ?>								
							<span class="checkIN"><input type="hidden" name="location_user" value="" /></span>	
						</div>
