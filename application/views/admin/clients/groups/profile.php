...
<div class="row">
    <?php echo form_open_multipart($this->uri->uri_string(), ['class' => 'client-form', 'autocomplete' => 'off']); ?>
    ...
    <div class="col-md-12">
            ...
            <div class="horizontal-tabs">
                <ul class="nav nav-tabs customer-profile-tabs nav-tabs-horizontal" role="tablist">
                  ...
                  if (total_rows(db_prefix() . 'customfields', ['fieldto' => 'customers', 'active' => 1]) > 0) {
                    ...
                    <li role="presentation">	
                        <a href="#customer_se_logs" aria-controls="customer_se_logs" role="tab"	
                            data-toggle="tab">	
                            <?php echo _l('Visit Log'); ?>	
                        </a>	
                    </li>
                    <?php } ?>
                </ul>
        ...
        <div class="tab-content mtop15">
                ...
                <div class="row">
                    ...
                    <div class="col-md-<?php echo !isset($client) ? 12 : 8; ?>">
                     ...
                     ?>
                        <div class="row">
                            <div class="col-md-6">
								 <?php $latitude = (isset($client) ? $client->latitude : ''); ?>
								 <?php echo render_input('latitude', 'customer_latitude', $latitude); ?>
							</div>
							<div class="col-md-6">
								 <?php $longitude = (isset($client) ? $client->longitude : ''); ?>
								 <?php echo render_input('longitude', 'customer_longitude', $longitude); ?>
							</div>
						</div>
                    </div>
                </div>
            ...
            <?php } ?>
            <div role="tabpanel" class="tab-pane" id="customer_se_logs">	
                <table class="table dt-table">	
                    <thead>	
                        <tr>	
